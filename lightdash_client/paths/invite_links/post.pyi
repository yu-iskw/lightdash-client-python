...
# body param
SchemaForRequestBodyApplicationJson = CreateInviteLink


request_body_create_invite_link = api_client.RequestBody(
    content={
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def results() -> typing.Type['InviteLink']:
                        return InviteLink
                    __annotations__ = {
                        "results": results,
                    }
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'InviteLink': ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> 'InviteLink': ...
...
class BaseApi(api_client.Api):
    ...
    def _create_invite_link_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_invite_link.serialize(body, content_type)
...
class CreateInviteLink(BaseApi):
    ...
    def create_invite_link(
        ...
        return self._create_invite_link_oapg(
            body=body,
