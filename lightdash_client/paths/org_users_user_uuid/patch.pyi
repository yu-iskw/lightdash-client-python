...
# Path params
UserUuidSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'userUuid': typing.Union[UserUuidSchema, str, uuid.UUID, ],
    }
)
...
request_path_user_uuid = api_client.PathParameter(
    name="userUuid",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_organization_member_oapg(
        self,
...
class UpdateOrganizationMember(BaseApi):
    ...
    def update_organization_member(
        ...
        return self._update_organization_member_oapg(
            body=body,
