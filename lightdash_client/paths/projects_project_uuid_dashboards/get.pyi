...
# Query params
ChartUuidSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'chartUuid': typing.Union[ChartUuidSchema, str, uuid.UUID, ],
    },
    total=False
)
...
request_query_chart_uuid = api_client.QueryParameter(
    name="chartUuid",
    style=api_client.ParameterStyle.FORM,
    schema=ChartUuidSchema,
    explode=True,
)
# Path params
                ...
                class properties:
                    ...
                    class results(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['DashboardListItem']:
                                return DashboardListItem

                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['DashboardListItem'], typing.List['DashboardListItem']],
                        ...
                        def __getitem__(self, i: int) -> 'DashboardListItem':
...
class GetDashboards(BaseApi):
    ...
    def get_dashboards(
        ...
        return self._get_dashboards_oapg(
