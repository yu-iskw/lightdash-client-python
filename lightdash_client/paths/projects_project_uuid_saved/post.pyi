...
# body param
SchemaForRequestBodyApplicationJson = CreateSavedChart


request_body_create_saved_chart = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_saved_chart_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_saved_chart.serialize(body, content_type)
...
class PostSavedChart(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_saved_chart(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def post_saved_chart(
        ...
        return self._post_saved_chart_oapg(
            body=body,
