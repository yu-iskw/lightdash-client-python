...
# Path params
JobUuidSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'jobUuid': typing.Union[JobUuidSchema, str, uuid.UUID, ],
    }
)
...
request_path_job_uuid = api_client.PathParameter(
    name="jobUuid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JobUuidSchema,
    required=True,
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'Job': ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> 'Job': ...
