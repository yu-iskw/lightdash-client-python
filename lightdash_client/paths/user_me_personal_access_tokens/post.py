...
# body param
SchemaForRequestBodyApplicationJson = CreatePersonalAccessToken


request_body_create_personal_access_token = api_client.RequestBody(
    content={
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def results() -> typing.Type['PersonalAccessTokenWithSecret']:
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'PersonalAccessTokenWithSecret': ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> 'PersonalAccessTokenWithSecret': ...
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_personal_access_token_oapg(
        self,
    ...
    def _create_personal_access_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_personal_access_token.serialize(body, content_type)
...
class CreatePersonalAccessToken(BaseApi):
    ...
    def create_personal_access_token(
        ...
        return self._create_personal_access_token_oapg(
            body=body,
