...
# body param
SchemaForRequestBodyApplicationJson = ProjectTablesConfiguration


request_body_project_tables_configuration = api_client.RequestBody(
    content={
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def results() -> typing.Type['ProjectTablesConfiguration']:
                        return ProjectTablesConfiguration
                    __annotations__ = {
                        "results": results,
                    }
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'ProjectTablesConfiguration': ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> 'ProjectTablesConfiguration': ...
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_project_tables_configuration_oapg(
        self,
    ...
    def _update_project_tables_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_tables_configuration.serialize(body, content_type)
...
class UpdateProjectTablesConfiguration(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_project_tables_configuration(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_project_tables_configuration(
        ...
        return self._update_project_tables_configuration_oapg(
            body=body,
