...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_tables_configuration_oapg(
        self,
...
class GetProjectTablesConfiguration(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_project_tables_configuration(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_project_tables_configuration(
        ...
        return self._get_project_tables_configuration_oapg(
