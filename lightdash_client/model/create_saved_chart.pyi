...
class CreateSavedChart(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["description"], typing_extensions.Literal["tableName"], typing_extensions.Literal["metricQuery"], typing_extensions.Literal["chartConfig"], typing_extensions.Literal["tableConfig"], typing_extensions.Literal["pivotConfig"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metricQuery"]) -> typing.Union[MetaOapg.properties.metricQuery, schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["chartConfig"]) -> typing.Union['ChartConfig', schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tableConfig"]) -> typing.Union[MetaOapg.properties.tableConfig, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["description"], typing_extensions.Literal["tableName"], typing_extensions.Literal["metricQuery"], typing_extensions.Literal["chartConfig"], typing_extensions.Literal["tableConfig"], typing_extensions.Literal["pivotConfig"], str, ]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        metricQuery: typing.Union[MetaOapg.properties.metricQuery, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        chartConfig: typing.Union['ChartConfig', schemas.Unset] = schemas.unset,
        tableConfig: typing.Union[MetaOapg.properties.tableConfig, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
