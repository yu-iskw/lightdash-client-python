...
class OrganizationUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userUuid", "firstName", "lastName", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userUuid", "firstName", "lastName", "email", ], str]):
