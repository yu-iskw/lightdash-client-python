...
T = TypeVar("T", bound="SchedulerOptionsType2")


@attr.s(auto_attribs=True)
class SchedulerOptionsType2:
    """
    Attributes:
        url (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scheduler_options_type_2.additional_properties = d
        return scheduler_options_type_2
