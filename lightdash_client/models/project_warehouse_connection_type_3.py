...
class ProjectWarehouseConnectionType3:
    """Construct a type with the properties of T except for those in type K.

    Attributes:
        type (ProjectWarehouseConnectionType3Type):
        project (str):
        dataset (str):
        threads (Union[Unset, float]):
        start_of_week (Union[Unset, None, ProjectWarehouseConnectionType3StartOfWeek]):
        timeout_seconds (Union[Unset, float]):
        priority (Union[Unset, ProjectWarehouseConnectionType3Priority]):
    ...
    start_of_week: Union[Unset, None, "ProjectWarehouseConnectionType3StartOfWeek"] = UNSET
    timeout_seconds: Union[Unset, float] = UNSET
    priority: Union[Unset, ProjectWarehouseConnectionType3Priority] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ProjectWarehouseConnectionType3Type(d.pop("type"))
        ...
        if _start_of_week is None:
            ...
            start_of_week = ProjectWarehouseConnectionType3StartOfWeek.from_dict(_start_of_week)
        ...
        if isinstance(_priority, Unset):
            ...
            priority = ProjectWarehouseConnectionType3Priority(_priority)
        ...
        project_warehouse_connection_type_3 = cls(
            type=type,
            project=project,
            dataset=dataset,
            threads=threads,
        ...
        project_warehouse_connection_type_3.additional_properties = d
        return project_warehouse_connection_type_3
