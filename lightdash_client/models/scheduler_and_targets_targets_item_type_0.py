...
T = TypeVar("T", bound="SchedulerAndTargetsTargetsItemType0")


@attr.s(auto_attribs=True)
class SchedulerAndTargetsTargetsItemType0:
    """
    Attributes:
        channel (str):
        scheduler_uuid (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scheduler_and_targets_targets_item_type_0 = cls(
            channel=channel,
        ...
        scheduler_and_targets_targets_item_type_0.additional_properties = d
        return scheduler_and_targets_targets_item_type_0
