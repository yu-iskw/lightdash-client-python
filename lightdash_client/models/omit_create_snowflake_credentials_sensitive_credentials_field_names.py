...
from ..models.omit_create_snowflake_credentials_sensitive_credentials_field_names_type import (
    OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.omit_create_snowflake_credentials_sensitive_credentials_field_names_start_of_week import (
        OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesStartOfWeek,
    )


T = TypeVar("T", bound="OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNames")


@attr.s(auto_attribs=True)
class OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNames:
    """Construct a type with the properties of T except for those in type K.

    Attributes:
        type (OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesType):
        account (str):
        database (str):
        warehouse (str):
        schema (str):
        ...
        start_of_week (Union[Unset, None, OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesStartOfWeek]):
    """
    ...
    start_of_week: Union[Unset, None, "OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesStartOfWeek"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesType(d.pop("type"))
        ...
        if _start_of_week is None:
            ...
            start_of_week = OmitCreateSnowflakeCredentialsSensitiveCredentialsFieldNamesStartOfWeek.from_dict(
                _start_of_week
            )

        omit_create_snowflake_credentials_sensitive_credentials_field_names = cls(
            type=type,
            account=account,
            database=database,
            warehouse=warehouse,
        ...
        omit_create_snowflake_credentials_sensitive_credentials_field_names.additional_properties = d
        return omit_create_snowflake_credentials_sensitive_credentials_field_names
