...
from ..models.get_project_response_200_results_warehouse_connection_type_1_type import (
    GetProjectResponse200ResultsWarehouseConnectionType1Type,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_project_response_200_results_warehouse_connection_type_1_start_of_week import (
        GetProjectResponse200ResultsWarehouseConnectionType1StartOfWeek,
    )


T = TypeVar("T", bound="GetProjectResponse200ResultsWarehouseConnectionType1")


@attr.s(auto_attribs=True)
class GetProjectResponse200ResultsWarehouseConnectionType1:
    """Construct a type with the properties of T except for those in type K.

    Attributes:
        type (GetProjectResponse200ResultsWarehouseConnectionType1Type):
        schema (str):
        host (str):
        port (float):
        dbname (str):
        threads (Union[Unset, float]):
        start_of_week (Union[Unset, None, GetProjectResponse200ResultsWarehouseConnectionType1StartOfWeek]):
    ...
    start_of_week: Union[Unset, None, "GetProjectResponse200ResultsWarehouseConnectionType1StartOfWeek"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetProjectResponse200ResultsWarehouseConnectionType1Type(d.pop("type"))
        ...
        if _start_of_week is None:
            ...
            start_of_week = GetProjectResponse200ResultsWarehouseConnectionType1StartOfWeek.from_dict(_start_of_week)
        ...
        get_project_response_200_results_warehouse_connection_type_1 = cls(
            type=type,
            schema=schema,
            host=host,
            port=port,
        ...
        get_project_response_200_results_warehouse_connection_type_1.additional_properties = d
        return get_project_response_200_results_warehouse_connection_type_1
