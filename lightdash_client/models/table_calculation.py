...
if TYPE_CHECKING:
    from ..models.table_calculation_format import TableCalculationFormat
...
class TableCalculation:
    ...
    Attributes:
        ...
        display_name (str):
        name (str):
        format_ (Union[Unset, TableCalculationFormat]):
    ...
    display_name: str
    name: str
    format_: Union[Unset, "TableCalculationFormat"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_format_, Unset):
            ...
            format_ = TableCalculationFormat.from_dict(_format_)
