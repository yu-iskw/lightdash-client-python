...
if TYPE_CHECKING:
    from ..models.resource_view_dashboard_item_data_updated_by_user import ResourceViewDashboardItemDataUpdatedByUser
    from ..models.resource_view_dashboard_item_data_validation_errors_item import (
        ResourceViewDashboardItemDataValidationErrorsItem,
    )


T = TypeVar("T", bound="ResourceViewDashboardItemData")


@attr.s(auto_attribs=True)
class ResourceViewDashboardItemData:
    ...
    Attributes:
        ...
        updated_by_user (Union[Unset, ResourceViewDashboardItemDataUpdatedByUser]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        validation_errors (Union[Unset, List['ResourceViewDashboardItemDataValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "ResourceViewDashboardItemDataUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["ResourceViewDashboardItemDataValidationErrorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.resource_view_dashboard_item_data_updated_by_user import (
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = ResourceViewDashboardItemDataUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = ResourceViewDashboardItemDataValidationErrorsItem.from_dict(
                validation_errors_item_data
            )

            validation_errors.append(validation_errors_item)

        resource_view_dashboard_item_data = cls(
            name=name,
            uuid=uuid,
        ...
        resource_view_dashboard_item_data.additional_properties = d
        return resource_view_dashboard_item_data
