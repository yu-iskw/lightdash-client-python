...
from ..models.get_space_response_200_results_queries_item_chart_type import (
    GetSpaceResponse200ResultsQueriesItemChartType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_space_response_200_results_queries_item_updated_by_user import (
        GetSpaceResponse200ResultsQueriesItemUpdatedByUser,
    )
    from ..models.get_space_response_200_results_queries_item_validation_errors_item import (
        GetSpaceResponse200ResultsQueriesItemValidationErrorsItem,
    )


T = TypeVar("T", bound="GetSpaceResponse200ResultsQueriesItem")


@attr.s(auto_attribs=True)
class GetSpaceResponse200ResultsQueriesItem:
    """
    Attributes:
        name (str):
        uuid (str):
        ...
        updated_by_user (Union[Unset, GetSpaceResponse200ResultsQueriesItemUpdatedByUser]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        validation_errors (Union[Unset, List['GetSpaceResponse200ResultsQueriesItemValidationErrorsItem']]):
        chart_type (Union[Unset, GetSpaceResponse200ResultsQueriesItemChartType]):
    """
    ...
    updated_by_user: Union[Unset, "GetSpaceResponse200ResultsQueriesItemUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["GetSpaceResponse200ResultsQueriesItemValidationErrorsItem"]] = UNSET
    chart_type: Union[Unset, GetSpaceResponse200ResultsQueriesItemChartType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = GetSpaceResponse200ResultsQueriesItemUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = GetSpaceResponse200ResultsQueriesItemValidationErrorsItem.from_dict(
        ...
        if isinstance(_chart_type, Unset):
            ...
            chart_type = GetSpaceResponse200ResultsQueriesItemChartType(_chart_type)

        get_space_response_200_results_queries_item = cls(
            name=name,
            uuid=uuid,
        ...
        get_space_response_200_results_queries_item.additional_properties = d
        return get_space_response_200_results_queries_item
