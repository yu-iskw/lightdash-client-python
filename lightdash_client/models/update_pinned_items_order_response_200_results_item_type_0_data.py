...
if TYPE_CHECKING:
    from ..models.update_pinned_items_order_response_200_results_item_type_0_data_updated_by_user import (
        UpdatePinnedItemsOrderResponse200ResultsItemType0DataUpdatedByUser,
    )
    from ..models.update_pinned_items_order_response_200_results_item_type_0_data_validation_errors_item import (
        UpdatePinnedItemsOrderResponse200ResultsItemType0DataValidationErrorsItem,
    )


T = TypeVar("T", bound="UpdatePinnedItemsOrderResponse200ResultsItemType0Data")


@attr.s(auto_attribs=True)
class UpdatePinnedItemsOrderResponse200ResultsItemType0Data:
    ...
    Attributes:
        ...
        updated_by_user (Union[Unset, UpdatePinnedItemsOrderResponse200ResultsItemType0DataUpdatedByUser]):
        ...
        validation_errors (Union[Unset,
            List['UpdatePinnedItemsOrderResponse200ResultsItemType0DataValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "UpdatePinnedItemsOrderResponse200ResultsItemType0DataUpdatedByUser"] = UNSET
    validation_errors: Union[
        Unset, List["UpdatePinnedItemsOrderResponse200ResultsItemType0DataValidationErrorsItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = UpdatePinnedItemsOrderResponse200ResultsItemType0DataUpdatedByUser.from_dict(
                _updated_by_user
            )
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = (
                UpdatePinnedItemsOrderResponse200ResultsItemType0DataValidationErrorsItem.from_dict(
        ...
        update_pinned_items_order_response_200_results_item_type_0_data = cls(
            name=name,
            uuid=uuid,
        ...
        update_pinned_items_order_response_200_results_item_type_0_data.additional_properties = d
        return update_pinned_items_order_response_200_results_item_type_0_data
