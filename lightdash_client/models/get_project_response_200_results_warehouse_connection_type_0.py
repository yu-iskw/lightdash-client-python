...
T = TypeVar("T", bound="GetProjectResponse200ResultsWarehouseConnectionType0")


@attr.s(auto_attribs=True)
class GetProjectResponse200ResultsWarehouseConnectionType0:
    """Construct a type with the properties of T except for those in type K.

    Attributes:
        type (GetProjectResponse200ResultsWarehouseConnectionType0Type):
        account (str):
        database (str):
        warehouse (str):
        schema (str):
        ...
        start_of_week (Union[Unset, None, GetProjectResponse200ResultsWarehouseConnectionType0StartOfWeek]):
    """
    ...
    start_of_week: Union[Unset, None, "GetProjectResponse200ResultsWarehouseConnectionType0StartOfWeek"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetProjectResponse200ResultsWarehouseConnectionType0Type(d.pop("type"))
        ...
        if _start_of_week is None:
            ...
            start_of_week = GetProjectResponse200ResultsWarehouseConnectionType0StartOfWeek.from_dict(_start_of_week)

        get_project_response_200_results_warehouse_connection_type_0 = cls(
            type=type,
            account=account,
            database=database,
            warehouse=warehouse,
        ...
        get_project_response_200_results_warehouse_connection_type_0.additional_properties = d
        return get_project_response_200_results_warehouse_connection_type_0
