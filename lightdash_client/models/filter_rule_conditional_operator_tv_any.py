...
T = TypeVar("T", bound="FilterRuleConditionalOperatorTVAny")


@_attrs_define
class FilterRuleConditionalOperatorTVAny:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filter_rule_conditional_operator_tv_any = cls(
            operator=operator,
            id=id,
            target=target,
            values=values,
        ...
        filter_rule_conditional_operator_tv_any.additional_properties = d
        return filter_rule_conditional_operator_tv_any
