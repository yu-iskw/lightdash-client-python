...
from ..models.get_pinned_items_response_200_results_item_type_1_data_chart_type import (
    GetPinnedItemsResponse200ResultsItemType1DataChartType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_pinned_items_response_200_results_item_type_1_data_updated_by_user import (
        GetPinnedItemsResponse200ResultsItemType1DataUpdatedByUser,
    )
    from ..models.get_pinned_items_response_200_results_item_type_1_data_validation_errors_item import (
        GetPinnedItemsResponse200ResultsItemType1DataValidationErrorsItem,
    )


T = TypeVar("T", bound="GetPinnedItemsResponse200ResultsItemType1Data")


@attr.s(auto_attribs=True)
class GetPinnedItemsResponse200ResultsItemType1Data:
    ...
    Attributes:
        ...
        updated_by_user (Union[Unset, GetPinnedItemsResponse200ResultsItemType1DataUpdatedByUser]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        validation_errors (Union[Unset, List['GetPinnedItemsResponse200ResultsItemType1DataValidationErrorsItem']]):
        chart_type (Union[Unset, GetPinnedItemsResponse200ResultsItemType1DataChartType]):
    """
    ...
    updated_by_user: Union[Unset, "GetPinnedItemsResponse200ResultsItemType1DataUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["GetPinnedItemsResponse200ResultsItemType1DataValidationErrorsItem"]] = UNSET
    chart_type: Union[Unset, GetPinnedItemsResponse200ResultsItemType1DataChartType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = GetPinnedItemsResponse200ResultsItemType1DataUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = GetPinnedItemsResponse200ResultsItemType1DataValidationErrorsItem.from_dict(
        ...
        if isinstance(_chart_type, Unset):
            ...
            chart_type = GetPinnedItemsResponse200ResultsItemType1DataChartType(_chart_type)

        get_pinned_items_response_200_results_item_type_1_data = cls(
            name=name,
            uuid=uuid,
        ...
        get_pinned_items_response_200_results_item_type_1_data.additional_properties = d
        return get_pinned_items_response_200_results_item_type_1_data
