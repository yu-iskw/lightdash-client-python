...
if TYPE_CHECKING:
    from ..models.get_space_response_200_results_dashboards_item_updated_by_user import (
        GetSpaceResponse200ResultsDashboardsItemUpdatedByUser,
    )
    from ..models.get_space_response_200_results_dashboards_item_validation_errors_item import (
        GetSpaceResponse200ResultsDashboardsItemValidationErrorsItem,
    )


T = TypeVar("T", bound="GetSpaceResponse200ResultsDashboardsItem")


@attr.s(auto_attribs=True)
class GetSpaceResponse200ResultsDashboardsItem:
    """
    Attributes:
        name (str):
        ...
        updated_by_user (Union[Unset, GetSpaceResponse200ResultsDashboardsItemUpdatedByUser]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        validation_errors (Union[Unset, List['GetSpaceResponse200ResultsDashboardsItemValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "GetSpaceResponse200ResultsDashboardsItemUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["GetSpaceResponse200ResultsDashboardsItemValidationErrorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = GetSpaceResponse200ResultsDashboardsItemUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = GetSpaceResponse200ResultsDashboardsItemValidationErrorsItem.from_dict(
                validation_errors_item_data
            )

            validation_errors.append(validation_errors_item)

        get_space_response_200_results_dashboards_item = cls(
            name=name,
        ...
        get_space_response_200_results_dashboards_item.additional_properties = d
        return get_space_response_200_results_dashboards_item
