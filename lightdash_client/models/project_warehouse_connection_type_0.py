...
from ..models.project_warehouse_connection_type_0_type import ProjectWarehouseConnectionType0Type
from ..types import UNSET
from ..types import Unset

if TYPE_CHECKING:
    from ..models.project_warehouse_connection_type_0_start_of_week import ProjectWarehouseConnectionType0StartOfWeek


T = TypeVar("T", bound="ProjectWarehouseConnectionType0")


@attr.s(auto_attribs=True)
class ProjectWarehouseConnectionType0:
    """Construct a type with the properties of T except for those in type K.

    Attributes:
        type (ProjectWarehouseConnectionType0Type):
        account (str):
        database (str):
        warehouse (str):
        schema (str):
        ...
        start_of_week (Union[Unset, None, ProjectWarehouseConnectionType0StartOfWeek]):
    """
    ...
    start_of_week: Union[Unset, None, "ProjectWarehouseConnectionType0StartOfWeek"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.project_warehouse_connection_type_0_start_of_week import (
            ProjectWarehouseConnectionType0StartOfWeek,
        )

        d = src_dict.copy()
        type = ProjectWarehouseConnectionType0Type(d.pop("type"))
        ...
        if _start_of_week is None:
            ...
            start_of_week = ProjectWarehouseConnectionType0StartOfWeek.from_dict(_start_of_week)

        project_warehouse_connection_type_0 = cls(
            type=type,
            account=account,
            database=database,
            warehouse=warehouse,
        ...
        project_warehouse_connection_type_0.additional_properties = d
        return project_warehouse_connection_type_0
