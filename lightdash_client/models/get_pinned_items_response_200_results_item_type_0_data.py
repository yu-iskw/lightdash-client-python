...
if TYPE_CHECKING:
    from ..models.get_pinned_items_response_200_results_item_type_0_data_updated_by_user import (
        GetPinnedItemsResponse200ResultsItemType0DataUpdatedByUser,
    )
    from ..models.get_pinned_items_response_200_results_item_type_0_data_validation_errors_item import (
        GetPinnedItemsResponse200ResultsItemType0DataValidationErrorsItem,
    )


T = TypeVar("T", bound="GetPinnedItemsResponse200ResultsItemType0Data")


@attr.s(auto_attribs=True)
class GetPinnedItemsResponse200ResultsItemType0Data:
    ...
    Attributes:
        ...
        updated_by_user (Union[Unset, GetPinnedItemsResponse200ResultsItemType0DataUpdatedByUser]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        validation_errors (Union[Unset, List['GetPinnedItemsResponse200ResultsItemType0DataValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "GetPinnedItemsResponse200ResultsItemType0DataUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["GetPinnedItemsResponse200ResultsItemType0DataValidationErrorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = GetPinnedItemsResponse200ResultsItemType0DataUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = GetPinnedItemsResponse200ResultsItemType0DataValidationErrorsItem.from_dict(
                validation_errors_item_data
            )

            validation_errors.append(validation_errors_item)

        get_pinned_items_response_200_results_item_type_0_data = cls(
            name=name,
            uuid=uuid,
        ...
        get_pinned_items_response_200_results_item_type_0_data.additional_properties = d
        return get_pinned_items_response_200_results_item_type_0_data
