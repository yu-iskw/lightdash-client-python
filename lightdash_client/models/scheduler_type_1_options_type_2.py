...
T = TypeVar("T", bound="SchedulerType1OptionsType2")


@attr.s(auto_attribs=True)
class SchedulerType1OptionsType2:
    """
    Attributes:
        url (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scheduler_type_1_options_type_2 = cls(
            url=url,
        ...
        scheduler_type_1_options_type_2.additional_properties = d
        return scheduler_type_1_options_type_2
