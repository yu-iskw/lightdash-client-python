...
T = TypeVar("T", bound="ApiCreateTagResponseResults")


@_attrs_define
class ApiCreateTagResponseResults:
    """
    Attributes:
        tag_uuid (str):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_create_tag_response_results = cls(
            tag_uuid=tag_uuid,
        )

        api_create_tag_response_results.additional_properties = d
