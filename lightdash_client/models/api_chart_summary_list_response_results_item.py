...
from ..models.api_chart_summary_list_response_results_item_chart_type import (
    ApiChartSummaryListResponseResultsItemChartType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiChartSummaryListResponseResultsItem")


@attr.s(auto_attribs=True)
class ApiChartSummaryListResponseResultsItem:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_chart_type, Unset):
            ...
            chart_type = ApiChartSummaryListResponseResultsItemChartType(_chart_type)

        api_chart_summary_list_response_results_item = cls(
            name=name,
        ...
        api_chart_summary_list_response_results_item.additional_properties = d
        return api_chart_summary_list_response_results_item
