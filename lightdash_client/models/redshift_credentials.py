...
class RedshiftCredentials:
    ...
    Attributes:
        type (RedshiftCredentialsType):
        schema (str):
        host (str):
        port (float):
        dbname (str):
        threads (Union[Unset, float]):
        start_of_week (Union[Unset, None, RedshiftCredentialsStartOfWeek]):
    ...
    start_of_week: Union[Unset, None, "RedshiftCredentialsStartOfWeek"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _start_of_week is None:
            ...
            start_of_week = RedshiftCredentialsStartOfWeek.from_dict(_start_of_week)
        ...
        redshift_credentials.additional_properties = d
