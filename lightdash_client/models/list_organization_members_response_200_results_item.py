...
from ..models.list_organization_members_response_200_results_item_role import (
    ListOrganizationMembersResponse200ResultsItemRole,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListOrganizationMembersResponse200ResultsItem")


@attr.s(auto_attribs=True)
class ListOrganizationMembersResponse200ResultsItem:
    ...
    Attributes:
        ...
        role (ListOrganizationMembersResponse200ResultsItemRole): The role of the user in the organization
    ...
    is_active: bool
    role: ListOrganizationMembersResponse200ResultsItemRole
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        role = ListOrganizationMembersResponse200ResultsItemRole(d.pop("role"))
        ...
        list_organization_members_response_200_results_item = cls(
            is_active=is_active,
            role=role,
        ...
        list_organization_members_response_200_results_item.additional_properties = d
        return list_organization_members_response_200_results_item
