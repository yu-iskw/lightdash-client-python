...
if TYPE_CHECKING:
    from ..models.create_space_in_project_response_200_results_dashboards_item_updated_by_user import (
        CreateSpaceInProjectResponse200ResultsDashboardsItemUpdatedByUser,
    )
    from ..models.create_space_in_project_response_200_results_dashboards_item_validation_errors_item import (
        CreateSpaceInProjectResponse200ResultsDashboardsItemValidationErrorsItem,
    )


T = TypeVar("T", bound="CreateSpaceInProjectResponse200ResultsDashboardsItem")


@attr.s(auto_attribs=True)
class CreateSpaceInProjectResponse200ResultsDashboardsItem:
    """
    Attributes:
        name (str):
        ...
        updated_by_user (Union[Unset, CreateSpaceInProjectResponse200ResultsDashboardsItemUpdatedByUser]):
        ...
        validation_errors (Union[Unset,
            List['CreateSpaceInProjectResponse200ResultsDashboardsItemValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "CreateSpaceInProjectResponse200ResultsDashboardsItemUpdatedByUser"] = UNSET
    validation_errors: Union[
        Unset, List["CreateSpaceInProjectResponse200ResultsDashboardsItemValidationErrorsItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = CreateSpaceInProjectResponse200ResultsDashboardsItemUpdatedByUser.from_dict(
                _updated_by_user
            )
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = CreateSpaceInProjectResponse200ResultsDashboardsItemValidationErrorsItem.from_dict(
                validation_errors_item_data
            )

            validation_errors.append(validation_errors_item)

        create_space_in_project_response_200_results_dashboards_item = cls(
            name=name,
        ...
        create_space_in_project_response_200_results_dashboards_item.additional_properties = d
        return create_space_in_project_response_200_results_dashboards_item
