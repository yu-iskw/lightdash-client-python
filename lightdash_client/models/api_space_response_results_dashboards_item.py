...
if TYPE_CHECKING:
    from ..models.api_space_response_results_dashboards_item_updated_by_user import (
        ApiSpaceResponseResultsDashboardsItemUpdatedByUser,
    )
    from ..models.api_space_response_results_dashboards_item_validation_errors_item import (
        ApiSpaceResponseResultsDashboardsItemValidationErrorsItem,
    )


T = TypeVar("T", bound="ApiSpaceResponseResultsDashboardsItem")


@attr.s(auto_attribs=True)
class ApiSpaceResponseResultsDashboardsItem:
    """
    Attributes:
        name (str):
        ...
        updated_by_user (Union[Unset, ApiSpaceResponseResultsDashboardsItemUpdatedByUser]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        validation_errors (Union[Unset, List['ApiSpaceResponseResultsDashboardsItemValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "ApiSpaceResponseResultsDashboardsItemUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["ApiSpaceResponseResultsDashboardsItemValidationErrorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = ApiSpaceResponseResultsDashboardsItemUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = ApiSpaceResponseResultsDashboardsItemValidationErrorsItem.from_dict(
                validation_errors_item_data
            )

            validation_errors.append(validation_errors_item)

        api_space_response_results_dashboards_item = cls(
            name=name,
        ...
        api_space_response_results_dashboards_item.additional_properties = d
        return api_space_response_results_dashboards_item
