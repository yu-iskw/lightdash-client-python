...
from ..models.api_validate_response_results_item_type_1_error_type import ApiValidateResponseResultsItemType1ErrorType
from ..models.api_validate_response_results_item_type_1_source import ApiValidateResponseResultsItemType1Source
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="ApiValidateResponseResultsItemType1")


@attr.s(auto_attribs=True)
class ApiValidateResponseResultsItemType1:
    """
    Attributes:
        project_uuid (str):
        error_type (ApiValidateResponseResultsItemType1ErrorType):
        error (str):
        name (str):
        created_at (datetime.datetime):
        validation_id (float):
        dashboard_views (float):
        source (Union[Unset, ApiValidateResponseResultsItemType1Source]):
    ...
    validation_id: float
    dashboard_views: float
    source: Union[Unset, ApiValidateResponseResultsItemType1Source] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        error_type = ApiValidateResponseResultsItemType1ErrorType(d.pop("errorType"))
        ...
        if isinstance(_source, Unset):
            ...
            source = ApiValidateResponseResultsItemType1Source(_source)
        ...
        api_validate_response_results_item_type_1 = cls(
        ...
        api_validate_response_results_item_type_1.additional_properties = d
        return api_validate_response_results_item_type_1
