...
T = TypeVar("T", bound="PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItem")


@attr.s(auto_attribs=True)
class PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItem:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.compact, PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItemCompactType0):
            compact = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItemType(d.pop("type"))
        ...
        def _parse_compact(
            ...
            try:
                ...
                compact_type_0: Union[Unset, PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItemCompactType0]
                if isinstance(_compact_type_0, Unset):
                    compact_type_0 = UNSET
                else:
                    compact_type_0 = PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItemCompactType0(
                        _compact_type_0
                    )
            ...
            compact_type_1: Union[Unset, PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItemCompactType1]
        ...
        post_run_underlying_data_query_json_body_additional_metrics_item = cls(
            type=type,
            sql=sql,
            table=table,
            name=name,
        ...
        return post_run_underlying_data_query_json_body_additional_metrics_item
