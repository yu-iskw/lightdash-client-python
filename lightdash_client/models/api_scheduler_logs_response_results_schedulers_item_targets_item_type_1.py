...
T = TypeVar("T", bound="ApiSchedulerLogsResponseResultsSchedulersItemTargetsItemType1")


@attr.s(auto_attribs=True)
class ApiSchedulerLogsResponseResultsSchedulersItemTargetsItemType1:
    """
    Attributes:
        recipient (str):
        scheduler_uuid (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_scheduler_logs_response_results_schedulers_item_targets_item_type_1 = cls(
            recipient=recipient,
        ...
        api_scheduler_logs_response_results_schedulers_item_targets_item_type_1.additional_properties = d
        return api_scheduler_logs_response_results_schedulers_item_targets_item_type_1
