...
T = TypeVar("T", bound="ApiSchedulerAndTargetsResponseResultsTargetsItemType0")


@attr.s(auto_attribs=True)
class ApiSchedulerAndTargetsResponseResultsTargetsItemType0:
    """
    Attributes:
        channel (str):
        scheduler_uuid (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_scheduler_and_targets_response_results_targets_item_type_0 = cls(
            channel=channel,
        ...
        api_scheduler_and_targets_response_results_targets_item_type_0.additional_properties = d
        return api_scheduler_and_targets_response_results_targets_item_type_0
