...
T = TypeVar("T", bound="DashboardSchedulerOptionsType2")


@attr.s(auto_attribs=True)
class DashboardSchedulerOptionsType2:
    """
    Attributes:
        url (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dashboard_scheduler_options_type_2 = cls(
            url=url,
        ...
        dashboard_scheduler_options_type_2.additional_properties = d
        return dashboard_scheduler_options_type_2
