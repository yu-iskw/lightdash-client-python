...
T = TypeVar("T", bound="MetricQueryResponseMetadata")


@attr.s(auto_attribs=True)
class MetricQueryResponseMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metric_query_response_metadata = cls(
            has_a_date_dimension=has_a_date_dimension,
        )

        metric_query_response_metadata.additional_properties = d
        return metric_query_response_metadata
