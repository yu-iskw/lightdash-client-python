...
T = TypeVar("T", bound="MetricExploreDataPointWithDateValue")


@_attrs_define
class MetricExploreDataPointWithDateValue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        date_value = d.pop("dateValue")

        metric_explore_data_point_with_date_value = cls(
        ...
        metric_explore_data_point_with_date_value.additional_properties = d
        return metric_explore_data_point_with_date_value
