...
T = TypeVar("T", bound="DashboardSemanticViewerChartTileProperties")


@_attrs_define
class DashboardSemanticViewerChartTileProperties:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dashboard_semantic_viewer_chart_tile_properties = cls(
            properties=properties,
            type=type,
        )

        dashboard_semantic_viewer_chart_tile_properties.additional_properties = d
        return dashboard_semantic_viewer_chart_tile_properties
