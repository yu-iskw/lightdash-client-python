...
T = TypeVar("T", bound="ApiShareResponseResults")


@attr.s(auto_attribs=True)
class ApiShareResponseResults:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_share_response_results = cls(
            params=params,
            path=path,
            nanoid=nanoid,
            host=host,
        ...
        api_share_response_results.additional_properties = d
        return api_share_response_results
