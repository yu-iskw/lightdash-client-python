...
class DashboardBasicDetails:
    ...
    Attributes:
        ...
        updated_by_user (Union[Unset, DashboardBasicDetailsUpdatedByUser]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        validation_errors (Union[Unset, List['DashboardBasicDetailsValidationErrorsItem']]):
    """
    ...
    updated_by_user: Union[Unset, "DashboardBasicDetailsUpdatedByUser"] = UNSET
    validation_errors: Union[Unset, List["DashboardBasicDetailsValidationErrorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = DashboardBasicDetailsUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = DashboardBasicDetailsValidationErrorsItem.from_dict(validation_errors_item_data)
