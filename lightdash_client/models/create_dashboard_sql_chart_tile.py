...
T = TypeVar("T", bound="CreateDashboardSqlChartTile")


@_attrs_define
class CreateDashboardSqlChartTile:
    """
    Attributes:
        w (float):
        h (float):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_dashboard_sql_chart_tile = cls(
            w=w,
            h=h,
            y=y,
            x=x,
        ...
        create_dashboard_sql_chart_tile.additional_properties = d
