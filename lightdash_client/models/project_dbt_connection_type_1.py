...
from ..models.project_dbt_connection_type_1_type import ProjectDbtConnectionType1Type

T = TypeVar("T", bound="ProjectDbtConnectionType1")


@attr.s(auto_attribs=True)
class ProjectDbtConnectionType1:
    """
    Attributes:
        type (ProjectDbtConnectionType1Type):
        api_key (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        type = ProjectDbtConnectionType1Type(d.pop("type"))
        ...
        project_dbt_connection_type_1 = cls(
            type=type,
            api_key=api_key,
            account_id=account_id,
            environment_id=environment_id,
        ...
        return project_dbt_connection_type_1
