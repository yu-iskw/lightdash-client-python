...
T = TypeVar("T", bound="ApiEmailStatusResponseResultsOtp")


@attr.s(auto_attribs=True)
class ApiEmailStatusResponseResultsOtp:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_email_status_response_results_otp = cls(
        ...
        api_email_status_response_results_otp.additional_properties = d
        return api_email_status_response_results_otp
