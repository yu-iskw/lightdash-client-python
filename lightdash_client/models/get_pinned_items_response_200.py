...
class GetPinnedItemsResponse200:
    """
    Attributes:
        results (List[Union['GetPinnedItemsResponse200ResultsItemType0', 'GetPinnedItemsResponse200ResultsItemType1',
            'GetPinnedItemsResponse200ResultsItemType2']]):
        status (GetPinnedItemsResponse200Status):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for results_item_data in self.results:
            ...
            if isinstance(results_item_data, GetPinnedItemsResponse200ResultsItemType0):
                results_item = results_item_data.to_dict()

            elif isinstance(results_item_data, GetPinnedItemsResponse200ResultsItemType1):
                results_item = results_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
            ...
            def _parse_results_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    results_item_type_0 = GetPinnedItemsResponse200ResultsItemType0.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    results_item_type_1 = GetPinnedItemsResponse200ResultsItemType1.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                results_item_type_2 = GetPinnedItemsResponse200ResultsItemType2.from_dict(data)
        ...
        status = GetPinnedItemsResponse200Status(d.pop("status"))

        get_pinned_items_response_200 = cls(
            results=results,
            status=status,
        )

        get_pinned_items_response_200.additional_properties = d
        return get_pinned_items_response_200
