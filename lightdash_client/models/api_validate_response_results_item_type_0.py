...
class ApiValidateResponseResultsItemType0:
    """
    Attributes:
        project_uuid (str):
        error_type (ApiValidateResponseResultsItemType0ErrorType):
        error (str):
        name (str):
        created_at (datetime.datetime):
        validation_id (float):
        chart_views (float):
        source (Union[Unset, ApiValidateResponseResultsItemType0Source]):
        ...
        chart_type (Union[Unset, ApiValidateResponseResultsItemType0ChartType]):
    ...
    validation_id: float
    chart_views: float
    source: Union[Unset, ApiValidateResponseResultsItemType0Source] = UNSET
    ...
    chart_type: Union[Unset, ApiValidateResponseResultsItemType0ChartType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        error_type = ApiValidateResponseResultsItemType0ErrorType(d.pop("errorType"))
        ...
        if isinstance(_source, Unset):
            ...
            source = ApiValidateResponseResultsItemType0Source(_source)
        ...
        if isinstance(_chart_type, Unset):
            ...
            chart_type = ApiValidateResponseResultsItemType0ChartType(_chart_type)

        chart_uuid = d.pop("chartUuid", UNSET)

        api_validate_response_results_item_type_0 = cls(
        ...
        api_validate_response_results_item_type_0.additional_properties = d
        return api_validate_response_results_item_type_0
