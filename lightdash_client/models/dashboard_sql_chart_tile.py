...
if TYPE_CHECKING:
    from ..models.dashboard_sql_chart_tile_properties_properties import (
        DashboardSqlChartTilePropertiesProperties,
    )


T = TypeVar("T", bound="DashboardSqlChartTile")


@_attrs_define
class DashboardSqlChartTile:
    """
    Attributes:
        uuid (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dashboard_sql_chart_tile.additional_properties = d
        return dashboard_sql_chart_tile
