...
T = TypeVar("T", bound="GetEmailVerificationStatusResponse200ResultsOtp")


@attr.s(auto_attribs=True)
class GetEmailVerificationStatusResponse200ResultsOtp:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_email_verification_status_response_200_results_otp = cls(
        ...
        get_email_verification_status_response_200_results_otp.additional_properties = d
        return get_email_verification_status_response_200_results_otp
