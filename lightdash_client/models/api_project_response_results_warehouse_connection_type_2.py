...
from ..models.api_project_response_results_warehouse_connection_type_2_type import (
    ApiProjectResponseResultsWarehouseConnectionType2Type,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.api_project_response_results_warehouse_connection_type_2_start_of_week import (
        ApiProjectResponseResultsWarehouseConnectionType2StartOfWeek,
    )


T = TypeVar("T", bound="ApiProjectResponseResultsWarehouseConnectionType2")


@attr.s(auto_attribs=True)
class ApiProjectResponseResultsWarehouseConnectionType2:
    """Construct a type with the properties of T except for those in type K.

    Attributes:
        type (ApiProjectResponseResultsWarehouseConnectionType2Type):
        schema (str):
        host (str):
        port (float):
        dbname (str):
        ...
        start_of_week (Union[Unset, None, ApiProjectResponseResultsWarehouseConnectionType2StartOfWeek]):
    ...
    start_of_week: Union[Unset, None, "ApiProjectResponseResultsWarehouseConnectionType2StartOfWeek"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ApiProjectResponseResultsWarehouseConnectionType2Type(d.pop("type"))
        ...
        if _start_of_week is None:
            ...
            start_of_week = ApiProjectResponseResultsWarehouseConnectionType2StartOfWeek.from_dict(_start_of_week)
        ...
        api_project_response_results_warehouse_connection_type_2 = cls(
            type=type,
            schema=schema,
            host=host,
            port=port,
        ...
        api_project_response_results_warehouse_connection_type_2.additional_properties = d
        return api_project_response_results_warehouse_connection_type_2
