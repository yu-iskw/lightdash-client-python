...
from ..models.get_organization_member_by_uuid_response_200_results_role import (
    GetOrganizationMemberByUuidResponse200ResultsRole,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOrganizationMemberByUuidResponse200Results")


@attr.s(auto_attribs=True)
class GetOrganizationMemberByUuidResponse200Results:
    ...
    Attributes:
        ...
        role (GetOrganizationMemberByUuidResponse200ResultsRole): The role of the user in the organization
    ...
    is_active: bool
    role: GetOrganizationMemberByUuidResponse200ResultsRole
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        role = GetOrganizationMemberByUuidResponse200ResultsRole(d.pop("role"))
        ...
        get_organization_member_by_uuid_response_200_results = cls(
            is_active=is_active,
            role=role,
        ...
        get_organization_member_by_uuid_response_200_results.additional_properties = d
        return get_organization_member_by_uuid_response_200_results
