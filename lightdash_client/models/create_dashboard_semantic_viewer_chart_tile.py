...
T = TypeVar("T", bound="CreateDashboardSemanticViewerChartTile")


@_attrs_define
class CreateDashboardSemanticViewerChartTile:
    """
    Attributes:
        w (float):
        h (float):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_dashboard_semantic_viewer_chart_tile = cls(
            w=w,
            h=h,
            y=y,
            x=x,
        ...
        create_dashboard_semantic_viewer_chart_tile.additional_properties = d
