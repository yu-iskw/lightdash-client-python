...
T = TypeVar("T", bound="GetShareUrlResponse200Results")


@attr.s(auto_attribs=True)
class GetShareUrlResponse200Results:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_share_url_response_200_results = cls(
            params=params,
            path=path,
            nanoid=nanoid,
            host=host,
        ...
        get_share_url_response_200_results.additional_properties = d
        return get_share_url_response_200_results
