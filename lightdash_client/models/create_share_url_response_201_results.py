...
T = TypeVar("T", bound="CreateShareUrlResponse201Results")


@attr.s(auto_attribs=True)
class CreateShareUrlResponse201Results:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_share_url_response_201_results = cls(
            params=params,
            path=path,
            nanoid=nanoid,
            host=host,
        ...
        create_share_url_response_201_results.additional_properties = d
        return create_share_url_response_201_results
