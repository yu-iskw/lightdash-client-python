...
T = TypeVar("T", bound="PickDashboardExcludeKeyofDashboardIsPrivateOrAccess")


@_attrs_define
class PickDashboardExcludeKeyofDashboardIsPrivateOrAccess:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pick_dashboard_exclude_keyof_dashboard_is_private_or_access = cls(
            name=name,
            uuid=uuid,
        ...
        pick_dashboard_exclude_keyof_dashboard_is_private_or_access.additional_properties = d
        return pick_dashboard_exclude_keyof_dashboard_is_private_or_access
