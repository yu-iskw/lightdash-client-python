...
T = TypeVar("T", bound="PickChartAsCodeExcludeKeyofChartAsCodeMetricQueryOrChartConfig")


@_attrs_define
class PickChartAsCodeExcludeKeyofChartAsCodeMetricQueryOrChartConfig:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pick_chart_as_code_exclude_keyof_chart_as_code_metric_query_or_chart_config = cls(
            name=name,
        ...
        pick_chart_as_code_exclude_keyof_chart_as_code_metric_query_or_chart_config.additional_properties = d
