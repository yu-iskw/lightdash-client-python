...
T = TypeVar("T", bound="ChartSchedulerOptionsType2")


@attr.s(auto_attribs=True)
class ChartSchedulerOptionsType2:
    """
    Attributes:
        url (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        chart_scheduler_options_type_2 = cls(
            url=url,
        ...
        chart_scheduler_options_type_2.additional_properties = d
        return chart_scheduler_options_type_2
