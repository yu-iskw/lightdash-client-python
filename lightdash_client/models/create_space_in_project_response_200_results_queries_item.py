...
from ..models.create_space_in_project_response_200_results_queries_item_chart_type import (
    CreateSpaceInProjectResponse200ResultsQueriesItemChartType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_space_in_project_response_200_results_queries_item_updated_by_user import (
        CreateSpaceInProjectResponse200ResultsQueriesItemUpdatedByUser,
    )
    from ..models.create_space_in_project_response_200_results_queries_item_validation_errors_item import (
        CreateSpaceInProjectResponse200ResultsQueriesItemValidationErrorsItem,
    )


T = TypeVar("T", bound="CreateSpaceInProjectResponse200ResultsQueriesItem")


@attr.s(auto_attribs=True)
class CreateSpaceInProjectResponse200ResultsQueriesItem:
    """
    Attributes:
        name (str):
        uuid (str):
        ...
        updated_by_user (Union[Unset, CreateSpaceInProjectResponse200ResultsQueriesItemUpdatedByUser]):
        pinned_list_uuid (Optional[str]):
        pinned_list_order (Optional[float]):
        first_viewed_at (Union[None, datetime.datetime, str]):
        validation_errors (Union[Unset, List['CreateSpaceInProjectResponse200ResultsQueriesItemValidationErrorsItem']]):
        chart_type (Union[Unset, CreateSpaceInProjectResponse200ResultsQueriesItemChartType]):
    """
    ...
    updated_by_user: Union[Unset, "CreateSpaceInProjectResponse200ResultsQueriesItemUpdatedByUser"] = UNSET
    validation_errors: Union[
        Unset, List["CreateSpaceInProjectResponse200ResultsQueriesItemValidationErrorsItem"]
    ] = UNSET
    chart_type: Union[Unset, CreateSpaceInProjectResponse200ResultsQueriesItemChartType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_updated_by_user, Unset):
            ...
            updated_by_user = CreateSpaceInProjectResponse200ResultsQueriesItemUpdatedByUser.from_dict(_updated_by_user)
        ...
        for validation_errors_item_data in _validation_errors or []:
            validation_errors_item = CreateSpaceInProjectResponse200ResultsQueriesItemValidationErrorsItem.from_dict(
        ...
        if isinstance(_chart_type, Unset):
            ...
            chart_type = CreateSpaceInProjectResponse200ResultsQueriesItemChartType(_chart_type)

        create_space_in_project_response_200_results_queries_item = cls(
            name=name,
            uuid=uuid,
        ...
        create_space_in_project_response_200_results_queries_item.additional_properties = d
        return create_space_in_project_response_200_results_queries_item
