...
T = TypeVar("T", bound="PostRunUnderlyingDataQueryJsonBody")


@attr.s(auto_attribs=True)
class PostRunUnderlyingDataQueryJsonBody:
    """metricQuery for the chart to run

    Attributes:
        table_calculations (List['PostRunUnderlyingDataQueryJsonBodyTableCalculationsItem']):
        limit (float):
        sorts (List['PostRunUnderlyingDataQueryJsonBodySortsItem']):
        filters (PostRunUnderlyingDataQueryJsonBodyFilters):
        metrics (List[str]):
        dimensions (List[str]):
        csv_limit (Union[Unset, float]):
        additional_metrics (Union[Unset, List['PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItem']]):
    """
    ...
    additional_metrics: Union[Unset, List["PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for table_calculations_item_data in _table_calculations:
            table_calculations_item = PostRunUnderlyingDataQueryJsonBodyTableCalculationsItem.from_dict(
        ...
        for sorts_item_data in _sorts:
            sorts_item = PostRunUnderlyingDataQueryJsonBodySortsItem.from_dict(sorts_item_data)

            sorts.append(sorts_item)

        filters = PostRunUnderlyingDataQueryJsonBodyFilters.from_dict(d.pop("filters"))
        ...
        for additional_metrics_item_data in _additional_metrics or []:
            additional_metrics_item = PostRunUnderlyingDataQueryJsonBodyAdditionalMetricsItem.from_dict(
                additional_metrics_item_data
            )

            additional_metrics.append(additional_metrics_item)

        post_run_underlying_data_query_json_body = cls(
        ...
        post_run_underlying_data_query_json_body.additional_properties = d
        return post_run_underlying_data_query_json_body
