...
T = TypeVar("T", bound="RecordStringFieldOrTableCalculationOrCustomDimensionOrMetric")


@_attrs_define
class RecordStringFieldOrTableCalculationOrCustomDimensionOrMetric:
    """Construct a type with a set of properties K of type T"""

    additional_properties: Dict[
        str, Union["CustomBinDimension", "CustomSqlDimension", "Field", "Metric", "TableCalculation"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        record_string_field_or_table_calculation_or_custom_dimension_or_metric = cls()
        ...
        for prop_name, prop_dict in d.items():
            ...
            def _parse_additional_property(
                data: object,
            ) -> Union["CustomBinDimension", "CustomSqlDimension", "Field", "Metric", "TableCalculation"]:
                try:
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                additional_property_type_3 = Metric.from_dict(data)
        ...
        record_string_field_or_table_calculation_or_custom_dimension_or_metric.additional_properties = (
            additional_properties
        )
        return record_string_field_or_table_calculation_or_custom_dimension_or_metric
    ...
    def __setitem__(
        self, key: str, value: Union["CustomBinDimension", "CustomSqlDimension", "Field", "Metric", "TableCalculation"]
    ) -> None:
