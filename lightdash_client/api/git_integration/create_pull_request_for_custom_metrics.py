...
def _get_kwargs(
    project_uuid: str,
    *,
    body: CreatePullRequestForCustomMetricsBody,
) -> Dict[str, Any]:
...
) -> Optional[CreatePullRequestForCustomMetricsResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CreatePullRequestForCustomMetricsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[CreatePullRequestForCustomMetricsResponse200]:
    return Response(
