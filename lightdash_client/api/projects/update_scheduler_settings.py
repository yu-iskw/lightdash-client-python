...
from ...models.update_scheduler_settings import UpdateSchedulerSettings
...
def _get_kwargs(
    project_uuid: str,
    *,
    body: UpdateSchedulerSettings,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/projects/{projectUuid}/schedulerSettings".format(
